...
public class ExampleAdapter extends BaseExpandableListAdapter {
	...
	private void populateProjects() {
		...
		mProjects.add(new Project(30, "<b>Do work</b>",
	...
	public Object getChild(int groupPosition, int childPosition) {
		...
		return mProjects.get(groupPosition).getTasks().get(childPosition);
	}

	@Override
	public long getGroupId(int groupPosition) {

		return mProjects.get(groupPosition).getId();
	}

	@Override
	public long getChildId(int groupPosition, int childPosition) {

		return ((Task) getChild(groupPosition, childPosition)).getId();
	}
	...
	public int getChildrenCount(int groupPosition) {
		...
		return ((Project) getGroup(groupPosition)).getTasks().size();
	}
	...
	public View getChildView(final int groupPosition, final int childPosition,
		...
		mHolder.mTitle.setText(Html
				.fromHtml(((Task) getChild(groupPosition, childPosition)).getTitle()));
		mHolder.mContent.setText(Html
				.fromHtml(((Task) getChild(groupPosition, childPosition)).getContent()));
